...
public enum SQLCode {
	...
	SQLITE_BUSY(5, "The model file is locked"),
	SQLITE_LOCKED(6, "A table in the model is locked"),
	SQLITE_NO_MEM(7, "A malloc() failed"),
	SQLITE_READONLY(8, "Attempt to write a readonly model"),
	SQLITE_INTERRUPT(9, "Operation terminated by sqlite3_interrupt()"),
	SQLITE_IO_ERROR(10, "Some kind of disk I/O error occurred"),
	SQLITE_CORRUPT(11, "The model disk image is malformed"),
	SQLITE_NOT_FOUND(12, "Unknown opcode in sqlite3_file_control()"),
	SQLITE_FULL(13, "Insertion failed because model is full"),
	SQLITE_CANT_OPEN(14, "Unable to open the model file"),
	SQLITE_PROTOCOL(15, "DatabaseModel lock protocol error"),
	SQLITE_EMPTY(16, "DatabaseModel is empty"),
	SQLITE_SCHEMA(17, "The model schema changed"),
	...
	SQLITE_FORMAT(24, "Auxiliary model format error"),
	SQLITE_RANGE(25, "2nd parameter to sqlite3_bind out of range"),
	SQLITE_NOT_A_DB(26, "File opened that is not a model file"),
